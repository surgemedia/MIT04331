...
gulp.task('sass', function() {
    return gulp.src(sass_files).pipe(concat('skin.css')).pipe(sass({
      ...
      errorHandler: onError
        ...
        cascade: false
    })).pipe(gulp.dest('render/')).pipe(browserSync.stream())
});
/*========================================
=            Render Minifying            =
========================================*/
...
gulp.task('watcher', ['include', 'sass', 'js', 'imagemin', 'fonts'], function() {
    ...
    gulp.watch("cwd/assets/sass/*.scss", ['sass']).on('change', browserSync.reload);
    gulp.watch("cwd/**/**/*.html", ['include']).on('change', browserSync.reload);
    gulp.watch("cwd/assets/images/*", ['imagemin']).on('change', browserSync.reload);
    gulp.watch("cwd/assets/js/*.js", ['js']).on('change', browserSync.reload);
